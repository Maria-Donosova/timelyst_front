...
*   **Environment Variables:** The project uses a `.env` file to manage environment variables. A `lib/.env` file should be created with the necessary backend URLs and API keys. 
