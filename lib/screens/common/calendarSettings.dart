...
class _CalendarSettingsState extends State<CalendarSettings> {
  ...
  late List<Map<String, bool>> _selectedMetadata;
  ...
  void initState() {
    ...
    // Initialize import selections for each calendar
    _selectedMetadata = List.generate(
      widget.calendars.length,
      (index) => {
        "subject": false,
        "description": false,
        "conferenceInfo": false,
        "organizer": false,
        "recipients": false,
      },
    );
...
//             ),
//           ),
//           _buildCalendarMetadataSelection(index),
//           const SizedBox(height: 12),
//           _buildCategorySelection(index),
//         ],
//       ),
...
//   Widget _buildCalendarMetadataSelection(int index) {
//     final calendar = widget.calendars[index];
//     return Padding(
//       padding: const EdgeInsets.only(bottom: 8.0),
//       child: Column(
